...
export class HomeListComponent {
  hotels = [
    { id: 1, name: 'Explora Atacama', location: 'Atacama, Chile', href: '/pages/client1' },
    { id: 2, name: 'Explora Valle Sagrado', location: 'Cusco, Peru', href: '/pages/client1'},
    { id: 3, name: 'Explora Rapa Nui', location: 'Ilha de Páscoa, Chile', href: '/pages/client1'},
